<aside class="admin-sidebar">
  ...
  <nav class="p-4 space-y-1">
    ...
    <a href="{{ route('admin.companies.index') }}" class="admin-sidebar-link {{ request()->routeIs('admin.companies.*') ? 'active' : '' }}">
      <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="pt-4 mt-4 border-t border-gray-100">
      <a href="{{ route('admin.about_page.index') }}" class="admin-sidebar-link {{ request()->routeIs('admin.about_page.*') ? 'active' : '' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="{{ route('admin.partner_page.index') }}" class="admin-sidebar-link {{ request()->routeIs('admin.partner_page.*') ? 'active' : '' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="{{ route('admin.help_page.index') }}" class="admin-sidebar-link {{ request()->routeIs('admin.help_page.*') ? 'active' : '' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="{{ route('admin.contact_page.index') }}" class="admin-sidebar-link {{ request()->routeIs('admin.contact_page.*') ? 'active' : '' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="{{ route('admin.home_page.index') }}" class="admin-sidebar-link {{ request()->routeIs('admin.home_page.*') ? 'active' : '' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
        </svg>
        Home Page
      ...
      <a href="{{ route('admin.settings.index') }}" class="admin-sidebar-link">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
