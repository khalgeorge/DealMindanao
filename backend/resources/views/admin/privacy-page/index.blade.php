        ...
        <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-8 space-y-5">
                <div class="flex items-center gap-3 px-4 py-3 bg-blue-50 border border-blue-100 rounded-lg">
                    ...
                    <a href="{{ url('/privacy') }}" target="_blank" class="text-xs font-black text-blue-600 hover:underline">{{ url('/privacy') }}</a>
                </div>
                <div>
                    ...
                    <input type="text" name="pp_meta_title" value="{{ old('pp_meta_title', $s['pp_meta_title']) }}" class="input" placeholder="Privacy Policy - DealMindanao" maxlength="70">
                ...
                <div>
                    ...
                    <textarea name="pp_meta_description" rows="3" class="input resize-none" placeholder="Brief description for search engines…" maxlength="160">{{ old('pp_meta_description', $s['pp_meta_description']) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="pp_meta_keywords" value="{{ old('pp_meta_keywords', $s['pp_meta_keywords']) }}" class="input" placeholder="privacy policy, data, DealMindanao">
                </div>
                <div>
                    ...
                    <input type="text" name="pp_canonical" value="{{ old('pp_canonical', $s['pp_canonical']) }}" class="input" placeholder="{{ url('/privacy') }}">
