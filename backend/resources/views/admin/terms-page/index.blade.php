        ...
        <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-8 space-y-5">
                <div class="flex items-center gap-3 px-4 py-3 bg-blue-50 border border-blue-100 rounded-lg">
                    ...
                    <a href="{{ url('/terms') }}" target="_blank" class="text-xs font-black text-blue-600 hover:underline">{{ url('/terms') }}</a>
                </div>
                <div>
                    ...
                    <input type="text" name="tos_meta_title" value="{{ old('tos_meta_title', $s['tos_meta_title']) }}" class="input" placeholder="Terms of Service - DealMindanao" maxlength="70">
                ...
                <div>
                    ...
                    <textarea name="tos_meta_description" rows="3" class="input resize-none" placeholder="Brief description for search engines…" maxlength="160">{{ old('tos_meta_description', $s['tos_meta_description']) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="tos_meta_keywords" value="{{ old('tos_meta_keywords', $s['tos_meta_keywords']) }}" class="input" placeholder="terms, conditions, service, DealMindanao">
                </div>
                <div>
                    ...
                    <input type="text" name="tos_canonical" value="{{ old('tos_canonical', $s['tos_canonical']) }}" class="input" placeholder="{{ url('/terms') }}">
