        ...
        <div class="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-8 space-y-5">
                <div class="flex items-center gap-3 px-4 py-3 bg-blue-50 border border-blue-100 rounded-lg">
                    ...
                    <a href="{{ url('/help') }}" target="_blank" class="text-xs font-black text-blue-600 hover:underline">{{ url('/help') }}</a>
                </div>
                <div>
                    ...
                    <input type="text" name="help_meta_title" value="{{ old('help_meta_title', $s['help_meta_title']) }}" class="input" placeholder="Help Center - DealMindanao" maxlength="70">
                ...
                <div>
                    ...
                    <textarea name="help_meta_description" rows="3" class="input resize-none" placeholder="Brief description for search engines…" maxlength="160">{{ old('help_meta_description', $s['help_meta_description']) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="help_meta_keywords" value="{{ old('help_meta_keywords', $s['help_meta_keywords']) }}" class="input" placeholder="help, FAQ, support, DealMindanao">
                </div>
                <div>
                    ...
                    <input type="text" name="help_canonical" value="{{ old('help_canonical', $s['help_canonical']) }}" class="input" placeholder="{{ url('/help') }}">
