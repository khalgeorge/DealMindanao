...
<div class="space-y-6">
    ...
    <form action="/admin/pages/{{ $page->id }}" method="POST" enctype="multipart/form-data" class="card max-w-4xl">
        @csrf
        @method('PUT')
    ...
    <div class="grid md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input name="slug" class="input" value="{{ old('slug', $page->slug) }}" required>
